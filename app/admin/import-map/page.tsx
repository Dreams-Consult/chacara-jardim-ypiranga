  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <div className="bg-[var(--card-bg)] rounded-xl shadow-lg p-6 mb-6">
        ...
        <ol className="space-y-2 text-[var(--foreground)] opacity-80">
          <li className="flex items-start gap-2">
            <span className="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center text-[var(--foreground)] text-sm font-bold flex-shrink-0">1</span>
            <span>Prepare um arquivo JSON com os dados do loteamento</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center text-[var(--foreground)] text-sm font-bold flex-shrink-0">2</span>
            <span>Faça upload do arquivo ou cole o conteúdo JSON no campo abaixo</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center text-[var(--foreground)] text-sm font-bold flex-shrink-0">3</span>
      ...
      {showExample && (
        <div className="bg-gray-900 rounded-xl border border-gray-700 p-6 mb-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-bold text-[var(--foreground)]">Exemplo de Arquivo JSON</h3>
            <button
              onClick={handleUseExample}
              className="px-4 py-2 bg-blue-500 hover:bg-blue-600 text-[var(--foreground)] rounded-lg font-semibold transition-colors text-sm"
            >
              Usar Este Exemplo
            </button>
          </div>
          ...
          <div className="mt-4 text-[var(--foreground)] opacity-70 text-sm space-y-3">
            <div>
              <p className="font-semibold text-[var(--foreground)] mb-1">Campos obrigatórios:</p>
            ...
            <div>
              <p className="font-semibold text-[var(--foreground)] mb-1">Status dos lotes:</p>
              <ul className="list-disc list-inside ml-4 space-y-1">
      ...
      <div className="bg-[var(--card-bg)] rounded-xl shadow-lg p-6">
        <h2 className="text-xl font-bold text-[var(--foreground)] mb-4">Upload do Arquivo</h2>
        ...
        <div className="text-center text-[var(--foreground)] opacity-50 font-semibold my-4">OU</div>
